...
<body>
    ...
    <!-- header -->
       ...
       <nav class="nav navbar navbar-expand-lg bg-primary p-4">
        <a href="index.php" class="navbar-brand text-white">Expense Managements systems</a>
        <button type="button" class="btn btn-sm bg-primary text-white navbar-toggler p-0" data-bs-toggle="collapse" data-bs-target="#coll">
          <i class="bi bi-grid p-5"></i>
        </button>
        <div class="collapse navbar-collapse" id="coll">
        <ul class="navbar-nav navbar-link" style="margin-left: 75%;">        
